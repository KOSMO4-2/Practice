...
<meta charset="UTF-8">
    ...
    <title>Bootstrap Admin Template : HYBRID</title>
	<!-- Bootstrap Styles-->
    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="/admin_index"><i class="fa fa-gear"></i> <strong>HYBRID</strong></a>
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
					...
					<li>
                        <a href="/admin_chart" class="active-menu"><i class="fa fa-bar-chart-o"></i> Charts</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="/admin_empty"><i class="fa fa-fw fa-file"></i> Empty Page</a>
                    </li>
                </ul>
