      ...
      <div class="row">
        <div class="col-md-6 pr-5">
          <div class="block-48">
              ...
              <p class="mb-0"><a href="#" class="btn btn-white px-3 py-2">가입하기</a></p>
            </div>
        </div>
    ...
    <div class="container">
      ...
      <div class="row align-items-center mb-5">
        <div class="col-md-7 order-md-2 mb-5 mb-md-0">
          <img src="/image/bg_1.jpg" alt="" class="img-fluid">
        </div>
      ...
      <div class="row align-items-center mb-5">
        <div class="col-md-7 mb-5 mb-md-0">
          <img src="/image/bg_2.jpg" alt="" class="img-fluid">
        </div>
      ...
      <div class="row mb-3 justify-content-center">
        <div class="col-md-8 text-center">
          <h2>You To You 멤버십</h2>
               <p class="lead">더 많은 기능이 필요하신가요? 적합한 요금으로 효율적인 마케팅을 시작해 보세요.구독해지는 언제든 가능합니다.</p>
         <!-- <p><a href="#" class="link-underline">View All Fundraisers</a></p> -->
        </div>
      </div>
    </div>
        ...
        <div class="col-md-12 block-11">
          <div class="nonloop-block-11 owl-carousel">
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="/image/img_1.jpg" alt="image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">베이직</a></h3>
                <p class="card-text">- 데이터 분석조회</p>
                <span class="donation-time mb-3 d-block">Last donation 1w ago</span>
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 28%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="fund-raised d-block">FREE</span>
                <input class="basic_btn" type="button" value="결제하기">
              </div>
            </div>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="/image/img_1.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">스탠다드</a></h3>
                <p class="card-text">- 데이터 분석조회</p>
                <span class="donation-time mb-3 d-block">Last donation 1w ago</span>
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 28%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="fund-raised d-block">월 29,000원</span>
                <input class="basic_btn" type="button" value="결제하기">
              </div>
            </div>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="/image/img_1.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">스타트업</a></h3>
                <p class="card-text">- 데이터 분석조회</p>
                <span class="donation-time mb-3 d-block">Last donation 1w ago</span>
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 28%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="fund-raised d-block">월 99,000원</span>
                <input class="basic_btn" type="button" value="결제하기">
              </div>
            </div>
            ...
            <div class="card fundraise-item">
              <a href="#"><img class="card-img-top" src="/image/img_1.jpg" alt="Image placeholder"></a>
              <div class="card-body">
                <h3 class="card-title"><a href="#">프로페셔널</a></h3>
                <p class="card-text">- 데이터 분석조회</p>
                <span class="donation-time mb-3 d-block">Last donation 1w ago</span>
                <div class="progress custom-progress-success">
                  <div class="progress-bar bg-primary" role="progressbar" style="width: 28%" aria-valuenow="28" aria-valuemin="0" aria-valuemax="100"></div>
                </div>
                <span class="fund-raised d-block">월 499,000원</span>
                <input class="basic_btn" type="button" value="결제하기">
              </div>
            </div>
