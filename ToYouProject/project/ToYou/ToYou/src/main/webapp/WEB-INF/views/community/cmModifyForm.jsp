...
<article class="card-body mx-auto" style="min-width:800px;max-width: 1000px;">
    ...
    <br>
		    ...
		    <div class="form-group input-group">
		        ...
		        <textarea class="form-control" name="communityDescription" id="communityDescription"  placeholder="Community Describtion" row=4 >${community.communityDescription}</textarea>
		    </div> <!-- form-group// -->
